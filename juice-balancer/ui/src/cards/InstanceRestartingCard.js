        ...
        <CenteredText>
          ...
          <span data-test-id="instance-status">
            <FormattedMessage
              ...
              defaultMessage="Smoothie Shop Instance ready again"
            />
          </span>
        </CenteredText>
      ...
      <CenteredCard>
        ...
        <span data-test-id="instance-status">
          <FormattedMessage
            ...
            defaultMessage="Smoothie Shop Instance is currently restarting. It should be ready in a couple of seconds."
          />
        </span>
      </CenteredCard>
    );
